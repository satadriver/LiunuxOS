...
TASK_STACK0_SIZE 		EQU 1000h
STACK_TOP_DUMMY			EQU 10H
...
CURRENT_TASK_TSS_BASE	EQU 0d00000H

AP_KSTACK_BASE			equ 01e00000h
...
TSSEXP_STACK0_ADDRESS 	EQU 5f0000h
...
MAIN_DLL_BASE			equ	1200000h
MAIN_DLL_SOURCE_BASE	equ	1300000h
