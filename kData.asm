...
;ESP ESP0 MUST BE BOTH DEFINED

KERNEL_TASK_STACK_BASE	EQU 600000H
KERNEL_TASK_STACK_TOP	equ (KERNEL_TASK_STACK_BASE + KERNEL_TASK_STACK_SIZE - STACK_TOP_DUMMY)
...
TSSINT13H_STACK_ADDRESS EQU TSSTIMER_STACK_TOP + STACK_TOP_DUMMY
TSSINT13H_STACK_TOP 	EQU (TSSINT13H_STACK_ADDRESS + KERNEL_TASK_STACK_SIZE - STACK_TOP_DUMMY)

;TSSCMOS_STACK_ADDRESS 	EQU TSSINT13H_STACK_TOP + STACK_TOP_DUMMY
;TSSCMOS_STACK_TOP 		EQU (TSSCMOS_STACK_ADDRESS + KERNEL_TASK_STACK_SIZE - STACK_TOP_DUMMY)
;TSSV86_STACK_ADDRESS 	EQU TSSCMOS_STACK_TOP + STACK_TOP_DUMMY
...
TSSINT13H_STACK0_ADDRESS EQU TSSTIMER_STACK0_TOP + STACK_TOP_DUMMY
TSSINT13H_STACK0_TOP 	EQU (TSSINT13H_STACK0_ADDRESS + TASK_STACK0_SIZE - STACK_TOP_DUMMY)

;TSSCMOS_STACK0_ADDRESS 	EQU TSSINT13H_STACK0_TOP + STACK_TOP_DUMMY
;TSSCMOS_STACK0_TOP 		EQU (TSSCMOS_STACK0_ADDRESS + TASK_STACK0_SIZE - STACK_TOP_DUMMY)
;TSSV86_STACK0_ADDRESS 	EQU TSSCMOS_STACK0_TOP + STACK_TOP_DUMMY
